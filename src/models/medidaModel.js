    ...
    AS kdMaximo, (select MAX(kills) FROM partidaUsuario WHERE fkUsuario = ${idUsuario}) AS maiorKill FROM partidaUsuario WHERE fkUsuario = ${idUsuario} ORDER BY idPartida DESC LIMIT ${limite_linhas};`;
